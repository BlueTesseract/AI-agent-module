...
class FoxGame:
    def __init__(self, player1, player2):
        ...
        self.board = GameBoard(self.board, out_of_board_symbols = [' '], p1=[player1.player_id], p2=[player2.player_id])
    ...
    def print_board(self):
        f1 = f2 = Back.GREEN
        board_color = Back.GREEN
        p1 = Fore.WHITE
        p2 = Fore.RED
        default = Fore.BLACK

        self.board.print_board(f1, f2, p1=p1, p2=p2, board_color=board_color, sep="", default=default)
